...
public class Vintage extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
        String[] metal = { "Gold", "Silver", "Black"};
        String[] design = { "Black", "Brown", "White"};
        String result;
