...
public class Linh extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    String[] metal = { "Gold", "Silver", "Rose Gold"};
    String[] design = { "Resin Blue", "Resin Green", "Resin Yellow"};
    String result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linh);
