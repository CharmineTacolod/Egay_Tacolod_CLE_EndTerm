...
public class Rose extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    String[] metal = { "Gold", "Silver", "Rose Gold"};
    String[] design = { "Red Rose", "Pink Rose", "Yellow Rose"};
    String result;
