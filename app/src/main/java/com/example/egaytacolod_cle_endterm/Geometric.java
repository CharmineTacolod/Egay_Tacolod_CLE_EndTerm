...
public class Geometric extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    String[] metal = { "Gold", "Silver", "Rose Gold"};
    String[] design = { "Square", "Triangle", "Circle"};
    String result;
