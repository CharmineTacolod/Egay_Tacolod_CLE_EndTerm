...
public class HardwareLink extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    String[] metal = { "Gold", "Silver", "Rose Gold"};
    String[] design = { "Small", "Medium", "large"};
    String result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hardware_link);
